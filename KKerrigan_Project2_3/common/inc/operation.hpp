...
Implementation of the Operation base class
Revision: added the virtual perform() method to the Operation class to complete the polymorph on Operation method
		  of this project
...
typedef std::stack<Operand::pointer_type> valueStack;
...
public:
	...
	virtual Operand::pointer_type perform(valueStack& valStk) { return nullptr; }
};
